...
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '6822298543').split()]
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002115684413').split()]
...
# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://saminurmondal12:gWvCJXujWrJ81v27@cluster0.hsu4l0a.mongodb.net/?retryWrites=true&w=majority")
...
URL = "https://demo-1nbw.onrender.com".format(FQDN) if ON_HEROKU or NO_PORT else \
    "https://demo-1nbw.onrender.com/".format(FQDN, PORT)
...
if HAS_SSL:
    URL = "https://demo-1nbw.onrender.com/".format(FQDN)
else:
    URL = "https://demo-1nbw.onrender.com/".format(FQDN)
